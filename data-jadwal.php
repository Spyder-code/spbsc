  <div class="container">
        <div class="jumbotron text-center bg-transparent margin-none">
            <h1>Daftar Jadwal Lapangan BHASKARA SPORT CENTER</h1>
            <p></p>
        </div>
        <div class="page-section">
            <div class="row">
                <div class="col-md-12 col-lg-12">
				 <h4 class="page-section-heading"> DAFTAR JADWAL FUTSAL BHASKARA SPORT CENTER</h4>
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                             <thead>
									...
									$SQL="SELECT * FROM tjadwal,tlapangan,tjam WHERE 
										  ...
										  tjadwal.kdJam=tjam.kdJam AND tjadwal.tglJadwal  ORDER BY 

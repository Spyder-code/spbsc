    <div class="parallax cover overlay cover-image-full home">
        <img class="parallax-layer" src='images/home19.jpg' height = "640" width = "426"  alt="Learning Cover" />
        <div class="parallax-layer overlay overlay-full overlay-bg-white bg-transparent" data-speed="8" data-opacity="true">
            <div class="v-center">
                <div class="page-section overlay-bg-white-strong relative paper-shadow" data-z="1">
                    <h1 class="text-display-2 margin-v-0-15 display-inline-block">SISTEM PEMINJAMAN BASKHARA SPORT CENTER</h1>
                    <?php
                    if(isset($_SESSION['username'])){

                        echo' <p class="text-subhead">Selamat Datang Di BASKHARA SPORT CENTER</p>';
                    }else{

                        echo'
   <a class="btn btn-green-500 btn-lg paper-shadow" data-hover-z="2" data-animated data-toggle="modal" href="#modal-overlay-signup">DAFTAR MEMBER SPBSC SEKARANG</a>

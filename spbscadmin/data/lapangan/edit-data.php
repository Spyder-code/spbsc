        ...
        <div class='widget-content nopadding'>
		  ...
		  <input type='hidden' name='id' value='$_data[kdLapangan]'>
           ...
           <div class='control-group'>
            ...
            <div class='control-group'>
              <label class='control-label'>Status Lapangan:</label>
              <div class='controls'>
                 <select name='status'>
                 if($_data[status_lapangan]== penuh){
                 <option value = 'penuh' selected ='selected'>Penuh</option>
                 }else{
            ...
            <div class='control-group'>
              <label class='control-label'>Harga Lapangan :</label>
              <div class='controls'>
                <input type'text' class='span2' placeholder='Harga Lapangan' name='txtHargaLapangan' value='$_data[harga_lapangan]' />
              </div>

...
if(isset($_SESSION['username']) AND isset($_SESSION['password'])){
	...
	if(empty($addres_file)){
		$SQL="INSERT INTO tlapangan (noLapangan,gambarLapangan,deskripsi,status_lapangan,harga_lapangan) VALUES ('$_POST[txtNoLapangan]','$_POST[txtDeskripsi]','$_POST[status]','$_POST[txtHargaLapangan]')";
	...
	";
		...
		$SQL="INSERT INTO tlapangan (noLapangan,deskripsi,gambarLapangan,status_lapangan,harga_lapangan) VALUES ('$_POST[txtNoLapangan]','$_POST[txtDeskripsi]','$filenameenkrip','$_POST[status]','$_POST[txtHargaLapangan]')";
	mysql_query($SQL) or die (mysql_error());
    echo"
	<script language='javascript'>
	window.alert('Data Berhasil Disimpan');
	...
	$SQL="UPDATE tlapangan SET noLapangan='$_POST[txtNoLapangan]',
							   ...
							   status_lapangan='$_POST[status]',
							   harga_lapangan='$_POST[txtHargaLapangan]'
							    
		  WHERE kdLapangan='$_POST[id]' order by kdLapangan DESC limit 1";	
	mysql_query($SQL) or die (mysql_error());
